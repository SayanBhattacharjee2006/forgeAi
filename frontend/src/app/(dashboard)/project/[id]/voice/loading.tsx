...
export default function VoiceLoading() {
  return (
    <div className="flex flex-col h-[calc(100vh-56px)] lg:h-screen bg-background text-foreground animate-fade-in">
      <div className="shrink-0 px-4 sm:px-6 py-3.5 border-b border-border bg-card/60 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-1">
            <div className="h-4 w-44 bg-accent/70 rounded animate-pulse" />
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <p className="text-xs font-mono text-muted-foreground animate-pulse mt-3">
          Initializing voice meeting room...
        </p>
      </div>
    </div>
  );
